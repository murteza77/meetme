 ...
 @section('content')
		...
		<h3 class="page-title"> {{ trans('general.user_management') }}
			<small>{{ trans('general.user_roles') }}</small>
		</h3>
		<!-- END PAGE TITLE-->
            ...
            <div class="col-md-12">                            
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                   <div class="portlet-title">                               	                                    
                        <div class="caption">
                            <span class="caption-subject font-green sbold uppercase">{{ trans('general.user_roles') }}</span>
                        </div>                                              
                        <div class="actions pull-right">
        					<a href="{{ route('addRole') }}" class="btn blue"> {{ trans('general.add') }}           
